...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
		...
		if dummy:
			...
			cv2.putText(frame_ui, f'x : {dummy_point.x:.2f}', (160, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
			cv2.putText(frame_ui, f'y : {dummy_point.y:.2f}', (240, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
			cv2.putText(frame_ui, f'z : {dummy_point.z:.2f}', (320, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
			cv2.putText(frame_ui, f'w : {dummy_point.w:.2f}', (400, 40), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)

# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #

		cv2.namedWindow("Frame " + str(cam_index), cv2.WINDOW_GUI_NORMAL)
		cv2.putText(frame_ui, f'x : {circle_point.x:.2f}', (160, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
		cv2.putText(frame_ui, f'y : {circle_point.y:.2f}', (240, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
		cv2.putText(frame_ui, f'z : {circle_point.z:.2f}', (320, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
		cv2.putText(frame_ui, f'w : {circle_point.w:.2f}', (400, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
